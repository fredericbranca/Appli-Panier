            ...
            var a = function() {
                function t(e) {
                    ...
                    var r = {
                        ...
                        names: ["x"],
                        test: function t(e) {
                            return Math.abs(e.current - e.target) > .1
                        }
                    }
                    ...
                    this._options.names.forEach(function(t) {
                        n._instances[t] = new o(n._options.initialValue, n._options.acceleration, n._options.friction)
                    });
                    this._raf = null
                }
                ...
                r(t, [{
                    ...
                    , {
                        ...
                        value: function t(e, n) {
                            ...
                            if (e != null) {
                                if (n != null) {
                                    if (this._handlers[e] && this._handlers[e].filter(function(t) {
                                            return t === n
