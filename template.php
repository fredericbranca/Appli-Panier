            ...
            <div class="container-fluid">
                ...
                <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav flex-grow-1 block">
                            <li class="nav-item">
                        ...
                        <ul class="navbar-nav ps-0 mt-2 pos">
                            <button class="btn position-relative me-5 panier">
                                <a href="Recap.php">
                                    <img src="cart.svg" class="filter">
                                    <span class="nb position-absolute top-0 start-100 translate-middle badge rounded-pill">
                                        <?php echo sumQtt(); ?>
